...
state_energ_src_frac <- state_energy_frac(x=yrs, y=micensus_energ, state="Assam", glm=FALSE)
fv_frac              <- state_fv_frac(x=yrs, y=agcensus_fv, state="Assam", glm=FALSE, na.ix=c())


## *** Uncomment this section for irrigation data ***

## ## 2. land use + irrigation data
## data <- agcensus[agcensus$State %in% "Assam",]
 
## ## ## land use
## ## yrs1 <- 1957:2013
## ## ludata <- get_lu_data(y=data)
## ## ludata <- ludata[7:63,]
## ## ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Total","Other_Fallow","Current_Fallow","Net_Cropped_Area","Tree_Crops","Permanent_Pasture","Culturable_Waste","Non_Agricultural_Uses","Barren_and_Unculturable"))

## ## ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Cultivated","Other_Fallow","Current_Fallow","Net_Cropped_Area"), na.ix=list(Current_Fallow=c(20), Other_Fallow=c(20), Net_Cropped_Area=c(20)))
...
## area <- sum(unique(indiastat1950$Area[indiastat1950$State %in% "Assam"]))
## ylim <- c(0,area)
...
ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Forest"), na.ix=list(Forest=c(18:20)))
...
ludata <- check_data(x=yrs1, y=ludata, columns=c("Barren_and_Unculturable"), na.ix=list(Barren_and_Unculturable=c(15:20,27:39)), legend.pos="topleft")
...
## forest[52:57] <- forest[52:57] - (forest[52] - forest[51])
## forest[8:14] <- forest[8:14] + (forest[15] - forest[14])
forest[15:18] <- forest[15:18] - (forest[18] - forest[19])
forest[15:51] <- forest[15:51] - (forest[15] - forest[14])
ludata$Forest <- forest

ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Forest"), na.ix=list(Forest=c(21,27:39)))
...
ppastur <- ludata$Permanent_Pasture
ppastur[1:14] <- ppastur[1:14] - (ppastur[14] - ppastur[20])
ludata$Permanent_Pasture <- ppastur

ludata <- check_data(x=yrs1, y=ludata, columns=c("Grass","Permanent_Pasture","Culturable_Waste"), na.ix=list(Permanent_Pasture=c(15:19,44), Culturable_Waste=c(38,44)))
ludata <- get_lu_data(y=ludata)
## ludata$Permanent_Pasture <- 0
## ludata$Culturable_Waste <- 1

nonagri <- ludata$Non_Agricultural_Uses
nonagri[19:26] <- nonagri[19:26] - (nonagri[19] - nonagri[18])
## nonagri[15:18] <- nonagri[15:18] + (nonagri[14] - nonagri[15])
## nonagri[17:44] <- nonagri[17:44] + (nonagri[16] - nonagri[17])
## nonagri[48:51] <- nonagri[48:51] + (nonagri[47] - nonagri[48])
nonagri[52:57] <- nonagri[52:57] - (nonagri[52] - nonagri[51])
nonagri[53:57] <- nonagri[53:57] - (nonagri[53] - nonagri[52])
nonagri[1:7] <- nonagri[1:7] + (nonagri[10] - nonagri[7])
nonagri[40:57] <- nonagri[40:57] - (nonagri[40] - nonagri[37])
nonagri[44:57] <- nonagri[44:57] - (nonagri[44] - nonagri[43])
nonagri[48:57] <- nonagri[48:57] + (nonagri[47] - nonagri[48])
ludata$Non_Agricultural_Uses <- nonagri

ludata <- check_data(x=yrs1, y=ludata, columns=c("Non_Agricultural_Uses"), na.ix=list(Non_Agricultural_Uses=c(7:10,21,27:36,38:39)))

barren <- ludata$Barren_and_Unculturable
barren[1:18] <- barren[1:18] - (barren[18] - barren[20])
barren[53:57] <- barren[53:57] + (barren[52] - barren[53])
## barren[52:57] <- barren[52:57] + (barren[51] - barren[52])
barren[40:51] <- barren[40:51] - (barren[51] - barren[52])
## barren[40:57] <- barren[40:57] - (barren[39] - barren[40])
ludata$Barren_and_Unculturable <- barren

ludata <- check_data(x=yrs1, y=ludata, columns=c("Barren_and_Unculturable"), na.ix=list(Barren_and_Unculturable=c(1:9,19,27:39)), legend.pos="topleft")
## ludata$Barren_and_Unculturable <- 1
...
ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Forest"), na.ix=list(Forest=c(52:55)))

cwaste <- ludata$Culturable_Waste
cwaste[19:21] <- cwaste[19:21] - (cwaste[19] - cwaste[18])
ludata$Culturable_Waste <- cwaste

ppastur <- ludata$Permanent_Pasture
ppastur[19:39] <- ppastur[19:39] + (ppastur[40] - ppastur[39])
ludata$Permanent_Pasture <- ppastur

ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Grass","Permanent_Pasture","Culturable_Waste"), na.ix=list(Permanent_Pasture=c(15:19), Culturable_Waste=c(24:38,44)))
ludata <- get_lu_data(y=ludata)
## ludata$Permanent_Pasture <- 0
## ludata$Culturable_Waste <- 1

nonagri <- ludata$Non_Agricultural_Uses
nonagri[19:51] <- nonagri[19:51] + (nonagri[18] - nonagri[19])
ludata$Non_Agricultural_Uses <- nonagri

ludata <- check_data(x=yrs1, y=ludata, columns=c("Non_Agricultural_Uses"), na.ix=list(Non_Agricultural_Uses=c(52:57)))

barren <- ludata$Barren_and_Unculturable
barren[38:52] <- barren[38:52] - (barren[38] - barren[37])
barren[1:14] <- barren[1:14] - (barren[14] - barren[22])
## barren[53:57] <- barren[53:57] + (barren[52] - barren[53])
## barren[52:57] <- barren[52:57] + (barren[51] - barren[52])
## barren[40:51] <- barren[40:51] - (barren[51] - barren[52])
## barren[40:57] <- barren[40:57] - (barren[39] - barren[40])
...
ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Barren_and_Unculturable"), na.ix=list(Barren_and_Unculturable=c(1:9,15:21,24:26)), legend.pos="topleft")
## ludata$Barren_and_Unculturable <- 1
...
forest <- ludata$Forest
forest[1:14] <- forest[1:14] + (forest[15] - forest[14])
forest[1:18] <- forest[1:18] - (forest[18] - forest[21])
## forest[40:44] <- forest[40:44] - (forest[40] - forest[39])
## forest[48:51] <- forest[48:51] - (forest[48] - forest[47])
## forest[52:57] <- forest[52:57] - (forest[52] - forest[51])
## forest[8:14] <- forest[8:14] + (forest[15] - forest[14])
...
ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Forest"), na.ix=list(Forest=c(17:21,25:39,52:57)))
...
ppastur <- ludata$Permanent_Pasture
ppastur[1:14] <- ppastur[1:14] + (ppastur[20] - ppastur[14])
ppastur[53:57] <- ppastur[53:57] + (ppastur[52] - ppastur[53])
ludata$Permanent_Pasture <- ppastur

ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Grass","Permanent_Pasture","Culturable_Waste"), na.ix=list(Permanent_Pasture=c(15:19), Culturable_Waste=c(44,56:57)))
ludata <- get_lu_data(y=ludata)
## ludata$Permanent_Pasture <- 0
## ludata$Culturable_Waste <- 1
...
ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Non_Agricultural_Uses"), na.ix=list(Non_Agricultural_Uses=c(19:20,45:47,52:57,15)))
...
ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Barren_and_Unculturable"), na.ix=list(Barren_and_Unculturable=c(19,38:39)), legend.pos="topleft")
## ludata$Barren_and_Unculturable <- 1
...
forest[1:39] <- forest[1:39] - (forest[39] - forest[40])
forest[1:51] <- forest[1:51] - (forest[51] - forest[52])
forest[1:18] <- forest[1:18] - (forest[18] - forest[23])
forest[38:44] <- forest[38:44] + (forest[45] - forest[44])
## ## forest[40:44] <- forest[40:44] - (forest[40] - forest[39])
## ## forest[48:51] <- forest[48:51] - (forest[48] - forest[47])
## ## forest[52:57] <- forest[52:57] - (forest[52] - forest[51])
## ## forest[8:14] <- forest[8:14] + (forest[15] - forest[14])
...
ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Forest"), na.ix=list(Forest=c(1:10,19:22,44:47)))

cwaste <- ludata$Culturable_Waste
cwaste[20:24] <- cwaste[20:24] - (cwaste[20] - cwaste[19])
cwaste[1:15] <- cwaste[1:15] - (cwaste[15] - cwaste[16])
ludata$Culturable_Waste <- cwaste

ppastur <- ludata$Permanent_Pasture
ppastur[1:14] <- ppastur[1:14] - (ppastur[14] - ppastur[19])
ludata$Permanent_Pasture <- ppastur

ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Grass","Permanent_Pasture","Culturable_Waste"), na.ix=list(Permanent_Pasture=c(1:10,15:18), Culturable_Waste=c(1:10,21,44)))
ludata <- get_lu_data(y=ludata)
## ludata$Permanent_Pasture <- 0
## ludata$Culturable_Waste <- 1

nonagri <- ludata$Non_Agricultural_Uses
nonagri[1:14] <- nonagri[1:14] + (nonagri[19] - nonagri[14])
## nonagri[19:57] <- nonagri[19:57] + (nonagri[19] - nonagri[14])
nonagri[40:57] <- nonagri[40:57] - (nonagri[40] - nonagri[39])
nonagri[52:57] <- nonagri[52:57] - (nonagri[52] - nonagri[51])
ludata$Non_Agricultural_Uses <- nonagri

ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Non_Agricultural_Uses"), na.ix=list(Non_Agricultural_Uses=c(1:10,15:18)))
...
## ## barren[53:57] <- barren[53:57] + (barren[52] - barren[53])
## ## barren[52:57] <- barren[52:57] + (barren[51] - barren[52])
## barren[40:44] <- barren[40:44] - (barren[44] - barren[45])
## barren[22:57] <- barren[22:57] - (barren[22] - barren[18])
## barren[38:57] <- barren[38:57] - (barren[38] - barren[37])
## ## barren[40:57] <- barren[40:57] - (barren[39] - barren[40])
ludata$Barren_and_Unculturable <- barren

ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Barren_and_Unculturable"), na.ix=list(Barren_and_Unculturable=c(19:21)), legend.pos="topleft")
## ludata$Barren_and_Unculturable <- 1
...
ludata <- check_data(x=yrs1, y=ludata, columns=c("Forest"), na.ix=list(Forest=c(1:19,38:51)))

cwaste <- ludata$Culturable_Waste
cwaste[15:19] <- cwaste[15:19] - (cwaste[15] - cwaste[14])
cwaste[22:24] <- cwaste[22:24] - (cwaste[22] - cwaste[21])
ludata$Culturable_Waste <- cwaste
...
ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Grass","Permanent_Pasture","Culturable_Waste"), na.ix=list(Permanent_Pasture=c(), Culturable_Waste=c(18:20,44)))
ludata <- get_lu_data(y=ludata)
## ludata$Permanent_Pasture <- 0
## ludata$Culturable_Waste <- 1

nonagri <- ludata$Non_Agricultural_Uses
nonagri[1:14] <- nonagri[1:14] - (nonagri[14] - nonagri[18])
## nonagri[19:51] <- nonagri[19:51] + (nonagri[18] - nonagri[19])
nonagri[48:57] <- nonagri[48:57] + (nonagri[47] - nonagri[48])
nonagri[52:57] <- nonagri[52:57] - (nonagri[52] - nonagri[51])
nonagri[1:18] <- nonagri[1:18] + (nonagri[25] - nonagri[18])
ludata$Non_Agricultural_Uses <- nonagri

ludata <- check_data(x=yrs1, y=ludata, columns=c("Non_Agricultural_Uses"), na.ix=list(Non_Agricultural_Uses=c(19:24,15:17,21,43:45)))
...
ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Barren_and_Unculturable"), na.ix=list(Barren_and_Unculturable=c()), legend.pos="topleft")
## ludata$Barren_and_Unculturable <- 1
...
ludata <- check_data(x=yrs1, y=ludata, columns=c("Forest"), na.ix=list(Forest=c(38:39,44:47)))
...
ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Grass","Permanent_Pasture","Culturable_Waste"), na.ix=list(Permanent_Pasture=c(), Culturable_Waste=c(44)))
ludata <- get_lu_data(y=ludata)
ludata$Permanent_Pasture <- 0
ludata$Culturable_Waste <- 1
...
barren[43:47] <- barren[43:47] - (barren[47] - barren[48])
## barren[38:52] <- barren[38:52] - (barren[38] - barren[37])
## barren[53:57] <- barren[53:57] + (barren[52] - barren[53])
## barren[52:57] <- barren[52:57] + (barren[51] - barren[52])
## barren[40:51] <- barren[40:51] - (barren[51] - barren[52])
## barren[40:57] <- barren[40:57] - (barren[39] - barren[40])
barren[40:42] <- barren[40:42] + (barren[43] - barren[42])
ludata$Barren_and_Unculturable <- barren

ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Barren_and_Unculturable"), na.ix=list(Barren_and_Unculturable=c(18,21,44,38:39)), legend.pos="topleft")
## ludata$Barren_and_Unculturable <- 1
...
forest <- ludata$Forest
forest[22:44] <- forest[22:44] + (forest[45] - forest[44])
...
ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Forest"), na.ix=list(Forest=c(20:21)))
...
ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Non_Agricultural_Uses"), na.ix=list(Non_Agricultural_Uses=c(17:18,21)))
...
## ## ix1 <- data_agcensus$State %in% "Assam"
...
## ## cropwise
## data_agcensus <- checkCropIrrigArea(x=yrs, y=data_agcensus, frac=TRUE, area=ar, crops=c("Rice_Autumn","Rice_Winter","Rice_Summer"), na.ix=list(Rice_Winter=c(55)))
## data_agcensus <- checkCropIrrigArea(x=yrs, y=data_agcensus, frac=TRUE, area=ar, crops=c("Sorghum_Kharif","Sorghum_Rabi"))
## data_agcensus <- checkCropIrrigArea(x=yrs, y=data_agcensus, frac=TRUE, area=ar, crops=c("Bajra","Maize","Ragi","Wheat","Barley"))
