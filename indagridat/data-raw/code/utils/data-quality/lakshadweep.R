...
nonagri[5:57] <- nonagri[5:57] - (nonagri[5] - nonagri[4])
...
ludata <- check_data(x=yrs1, y=ludata, columns=c("Area","Non_Agricultural_Uses"), na.ix=list(Non_Agricultural_Uses=c(30:45)))
...
data <- check_data(x=yrs, y=data, columns=c("Fruit_and_Veg","Cotton","Tobacco"),          na.ix=list(Fruit_and_Veg=c(18:20),Cotton=c(),Tobacco=c()), ylim=ylim)
