...
icrisat.combined.data.1960 <- do.call(rbind, data)
names(icrisat.combined.data.1960) <- readRDS(file.path(aux.path, "names_icrisat.rds"))
saveRDS(icrisat.combined.data.1960, file.path(mod.path, "icrisat_combined_data_1960.rds"))
